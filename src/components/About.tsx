...
function About() {
  return (
    ...
    <div className='text-center md:text-left max-w-[70%]'>
      <h1 className='text-4xl md:text-5xl font-bold'>NAHUEL CAROSELI</h1>
      <p className='text-xl pt-10 md:text-3xl font-bold'>full-stack developer</p>
      <p className='text-xl pt-10'>Soy desarrollador de aplicaciones web full-stack. Me especializo en aplicar patrones de diseño y principios de programación sólidos para crear soluciones eficientes y escalables. Me apasiona aprender nuevas tecnologías y aplicar las mejores prácticas en el desarrollo de software.</p>
    </div>
    <div className='flex md:flex-row md:gap-x-5 md:pl-30 flex-wrap justify-center'>
      <img src="/about-1.jpg" className='w-50 h-50 md:w-70 h-70 rounded-4xl object-cover mt-20 transition duration-200 hover:scale-105' alt="" id="about_2"  draggable="false"/>
    </div>
  </div>
  )
}
